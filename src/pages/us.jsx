    ...
    return (
        <div id="Us">
          ...
          <div id='bg-map'>
            ...
            width="400vw" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <p><strong style={{ fontSize: '1.5em', fontWeight: 'bold' }}>Visita nuestra sede en:<br/> Suba - Almendros<br/><br/></strong> Te invitamos a probar
          nuestra experiencia JR en persona!</p>
          <div>
          </div>
        </div>
      );
